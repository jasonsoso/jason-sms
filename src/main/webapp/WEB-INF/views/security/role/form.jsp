...
<!-- Header Start -->
		...
		<div id="container">
			...
			<div id="main-content">
				...
				<div class="databox">
					<div class="databox-title">用户角色管理&nbsp;（所有带有<span class="red" style="color: red;" >*</span>为必填项）</div>
					<div class="databox-body">
						<div class="changepwd formbox">
							<div class="form-group">
								<span class="form-title">显示名称：</span>
								<form:input path="showName" cssClass="required ipt ipt-size1" />
		...
		<script type="text/javascript">
			$(function(){
				$("#form").validate(); 
				$("#back").click(function(){
					location.href = "${ctx}/security/role/list/";
				});
			});
		</script>
