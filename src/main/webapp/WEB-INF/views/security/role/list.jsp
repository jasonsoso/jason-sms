...
<body>
		...
		<div id="container">
			...
			<form id="myForm" action="${ctx }/security/role/list/" method="get">
				<h3 class="page-title">用户角色管理</h3>
				<div class="title-line"></div>
				<div class="cl"></div>
				<div class="searchbar">
					<div class="search-group fl">
						<span>名称：</span>
						<input class="ipt ipt-size1" name="params[showName]" value="${page.params.showName }" type="text" />
					</div>
					<div class="search-group fl">
				...
				<div class="class-info">
					<div class="databox">
						<div class="databox-title">用户角色管理&nbsp;
							...
							<table class="table table-bordered">
								<thead>
									<tr class="titletr">
										...
										<th>显示名称</th><th>名称</th><th>操作</th></tr>	
								</thead>
								<tbody>
									  <c:choose>
									  	<c:when test="${not empty page.result }">
										  	...
										  	<tr class="even">
											    <td class="checktd">
											    	<div class="checker">
											    	<span><input type="checkbox" name="items" id="checkbox" value="${role.id}" class="group-checkable" /></span>
											    	</div>
											    </td>
											    <td>${role.showName}</td>
											    <td>${role.name }</td>
											    <td>
													<a href="${ctx }/security/role/${role.id}/edit/" class="do-btn edit-btn"><span>编辑</span></a>
